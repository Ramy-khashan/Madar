    ...
    return Column(
       children: [
        SafeArea(
          child: InkWell(
            onTap: () {
              RouterHandler.navigate(context, AppRouterKeys.propertyDetails,extra: property?.id);
            },
            child: Container(
              width:context.isMobilePortrait?context.screenWidth*0.91: context.screenWidth * 0.4,
                            ...
                            Row(
                              children: [
                                PropertyItem(
                                  ...
                                  label: '${property?.beds ?? 0}',
                                  colors: colors,
                                ),
                                SizedBox(width: 10.width),
                                PropertyItem(
                                  icon: AppImages.balconyIcon,
                                  label: '${property?.balconies ?? 0}',
                                  colors: colors,
                                ),
                                SizedBox(width: 10.width),
                                PropertyItem(
