          ...
          Expanded(
            child: AppTextField(
              ...
              suffixIconWidget: GestureDetector(
                onTap: () {
                  ConversationDetailBloc.get(context).add(
                    ConversationDetailSendMessage(
                      ConversationDetailBloc.get(
                        context,
              ...
              isWithTitle: false,
              controller: ConversationDetailBloc.get(context).messageController,
            ),
          ),
