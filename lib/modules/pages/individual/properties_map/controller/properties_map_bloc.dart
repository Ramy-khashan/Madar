...
class PropertiesMapBloc extends Bloc<PropertiesMapEvent, PropertiesMapState> {
  ...
  PositionModel get targetPosition =>
      initialPosition ?? propertyMarkers.first;
  ...
  static final Map<int, Future<({BitmapDescriptor normal, BitmapDescriptor selected})>>
      _iconCache = {};
  ...
  static Future<({BitmapDescriptor normal, BitmapDescriptor selected})>
    ...
    return _iconCache.putIfAbsent(key, () async {
      ...
      final selected = await _drawPinMarker(
        color: brandColor,
        iconColor: ui.Color.fromARGB(115, 31, 60, 94),
        width: 48.0,
        height: 60.0,
        isSelected: true,
      );
  ...
  static Future<BitmapDescriptor> _drawPinMarker({
    ...
    final path = Path()
      ...
      ..arcTo(
        Rect.fromCircle(
          center: Offset(radius, circleCenterY),
          radius: radius,
        ),
        math.pi,
        -math.pi,
    ...
    canvas.drawPath(
      ...
      Paint()
        ...
        ..maskFilter =
            MaskFilter.blur(BlurStyle.normal, isSelected ? 8.0 : 4.0),
    );
  ...
  void _onSelectMarker(
    ...
    if (event.index < sampleProperties.length) {
      emit(PropertiesMapMarkerSelected(
  ...
  static final List<PropertyBuyerModel> sampleProperties = [
    PropertyBuyerModel(
      ...
      occupancyRate: '100%',
      latLng: const LatLng(24.7136, 46.6753),
    ),
    PropertyBuyerModel(
      id: '2',
      ...
      insuranceInfo: _defaultInsuranceInfo,
      occupancyRate: '100%',
      latLng: const LatLng(24.7180, 46.6700),
    ),
    PropertyBuyerModel(
      id: '3',
      ...
      insuranceInfo: _defaultInsuranceInfo,
      occupancyRate: '100%',
      latLng: const LatLng(24.7095, 46.6810),
    ),
    PropertyBuyerModel(
      id: '4',
      ...
      insuranceInfo: _defaultInsuranceInfo,
      occupancyRate: '0%',
      latLng: const LatLng(24.7060, 46.6650),
    ),
    PropertyBuyerModel(
      id: '5',
      ...
      insuranceInfo: _defaultInsuranceInfo,
      occupancyRate: '100%',
      latLng: const LatLng(24.7210, 46.6780),
    ),
  ];
}
